# Remove old codebase
```
rm -rf 21st material-color-utilities Prismui ui react-icons originui react-bits shadcn-builder
```

# Add new codebase
```
git clone https://github.com/react-icons/react-icons && cd react-icons && rm -rf .git && cd ..
